...
// ThreadTreeApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CThreadTreeApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CThreadTreeApp

CThreadTreeApp::CThreadTreeApp()
{
...
// Единственный объект CThreadTreeApp

CThreadTreeApp theApp;


// Инициализация CThreadTreeApp

BOOL CThreadTreeApp::InitInstance()
{
